...
GPIO_PinConfig gpioPinConfigs[] = {
    ...
    BOARD_GPIO_SENSOR_PIN | GPIO_CFG_INPUT,
    ...
    BOARD_SHUTTER_COIL0_P_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_SHUTTER_COIL0_N_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_SHUTTER_COIL1_P_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_SHUTTER_COIL1_N_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_DRUM_EN_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_DRUM_COIL0_P_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_DRUM_COIL0_N_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_DRUM_COIL1_P_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW,
    BOARD_DRUM_COIL1_N_PIN | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_HIGH | GPIO_CFG_OUT_LOW
};
